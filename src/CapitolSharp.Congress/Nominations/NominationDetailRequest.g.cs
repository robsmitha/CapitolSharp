...
namespace CapitolSharp.Congress.Nominations
{
	...
	/// </summary>
	public class NominationDetailRequest : JsonFormatApiRequest<NominationDetail.NominationDetailResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/nomination/{0}/{1}", Congress, NominationNumber);
	}
}
