...
namespace CapitolSharp.Congress.Treaties
{
	...
	/// </summary>
	public class TreatyDetailRequest : JsonFormatApiRequest<TreatyDetail.TreatyDetailResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/treaty/{0}/{1}", Congress, TreatyNumber);
	}
}
