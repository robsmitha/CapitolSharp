...
namespace CapitolSharp.Congress.HouseRequirements.HouseRequirement
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "11.0.0.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class HouseRequirementResponse
    {
        [Newtonsoft.Json.JsonProperty("houseRequirements", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<HouseRequirement> HouseRequirements { get; set; }
