...
namespace CapitolSharp.Congress.Bills
{
	...
	/// </summary>
	public class BillRelatedbillsRequest : PagedApiRequest<BillRelatedbills.BillRelatedbillsResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/bill/{0}/{1}/{2}/relatedbills", Congress, BillType, BillNumber);
	}
}
