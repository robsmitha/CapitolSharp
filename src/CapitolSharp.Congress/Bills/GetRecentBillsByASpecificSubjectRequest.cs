...
namespace CapitolSharp.Congress.Bills
{
    ...
    /// </summary>
    public class GetRecentBillsByASpecificSubjectRequest : ProPublicaApiRequest<GetRecentBillsByASpecificSubjectResponse>
    {
        /// <summary>
        ...
        /// </summary>
        internal override ProPublicaApiEndpoint Endpoint => new("/bills/subjects/{0}.json", Subject);
    }
}
