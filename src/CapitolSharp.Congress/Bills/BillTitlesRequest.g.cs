...
namespace CapitolSharp.Congress.Bills
{
	...
	/// </summary>
	public class BillTitlesRequest : PagedApiRequest<BillTitles.BillTitlesResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/bill/{0}/{1}/{2}/titles", Congress, BillType, BillNumber);
	}
}
