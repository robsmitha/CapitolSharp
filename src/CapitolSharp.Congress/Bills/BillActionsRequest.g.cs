...
namespace CapitolSharp.Congress.Bills
{
	...
	/// </summary>
	public class BillActionsRequest : PagedApiRequest<BillActions.BillActionsResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/bill/{0}/{1}/{2}/actions", Congress, BillType, BillNumber);
	}
}
