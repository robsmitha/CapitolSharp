...
namespace CapitolSharp.Congress.Committees
{
	...
	/// </summary>
	public class CommitteeBillsListRequest : DateRangeApiRequest<CommitteeBillsList.CommitteeBillsListResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/committee/{0}/{1}/bills", Chamber, CommitteeCode);
	}
}
