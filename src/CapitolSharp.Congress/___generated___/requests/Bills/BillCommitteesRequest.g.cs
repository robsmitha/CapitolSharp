...
namespace CapitolSharp.Congress.Bills
{
	...
	/// </summary>
	public class BillCommitteesRequest : PagedApiRequest<BillCommittees.BillCommitteesResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/bill/{0}/{1}/{2}/committees", Congress, BillType, BillNumber);
	}
}
