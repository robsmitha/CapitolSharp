...
namespace CapitolSharp.Congress.Bills
{
	...
	/// </summary>
	public class BillSummariesRequest : PagedApiRequest<BillSummaries.BillSummariesResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/bill/{0}/{1}/{2}/summaries", Congress, BillType, BillNumber);
	}
}
