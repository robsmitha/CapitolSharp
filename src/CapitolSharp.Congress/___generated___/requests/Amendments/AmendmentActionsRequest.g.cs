...
namespace CapitolSharp.Congress.Amendments
{
	...
	/// </summary>
	public class AmendmentActionsRequest : PagedApiRequest<AmendmentActions.AmendmentActionsResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/amendment/{0}/{1}/{2}/actions", Congress, AmendmentType, AmendmentNumber);
	}
}
