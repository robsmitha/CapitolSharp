...
namespace CapitolSharp.Congress.CommitteeReports
{
	...
	/// </summary>
	public class CommitteeReportDetailsRequest : JsonFormatApiRequest<CommitteeReportDetails.CommitteeReportDetailsResponse>
	{
		/// <summary>
		...
		public override CongressApiEndpoint Endpoint => new("/committee-report/{0}/{1}/{2}", Congress, ReportType, ReportNumber);
	}
}
